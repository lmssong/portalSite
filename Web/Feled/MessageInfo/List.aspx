<%@ Page Title="MessageInfo" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Maticsoft.Web.MessageInfo.List" %>
...
<!--Title -->
            ...
            <asp:GridView ID="gridView" runat="server" AllowPaging="True" Width="100%" CellPadding="3"  OnPageIndexChanging ="gridView_PageIndexChanging"
                    BorderWidth="1px" DataKeyNames="MessID" OnRowDataBound="gridView_RowDataBound"
		...
		<asp:BoundField DataField="MessTitle" HeaderText="MessTitle" SortExpression="MessTitle" ItemStyle-HorizontalAlign="Center"  /> 
		...
		<asp:BoundField DataField="Messcontent" HeaderText="Messcontent" SortExpression="Messcontent" ItemStyle-HorizontalAlign="Center"  /> 
                            
                            <asp:HyperLinkField HeaderText="ÏêÏ¸" ControlStyle-Width="50" DataNavigateUrlFields="MessID" DataNavigateUrlFormatString="Show.aspx?id={0}"
                                Text="ÏêÏ¸"  />
                            <asp:HyperLinkField HeaderText="±à¼­" ControlStyle-Width="50" DataNavigateUrlFields="MessID" DataNavigateUrlFormatString="Modify.aspx?id={0}"
                                Text="±à¼­"  />
