...
<!--Title -->
		...
		<asp:BoundField DataField="NicheContent" HeaderText="NicheContent" SortExpression="NicheContent" ItemStyle-HorizontalAlign="Center"  /> 
                            ...
                            <asp:HyperLinkField HeaderText="ÏêÏ¸" ControlStyle-Width="50" DataNavigateUrlFields="NicheID" DataNavigateUrlFormatString="Show.aspx?id={0}"
                                Text="ÏêÏ¸"  />
                            <asp:HyperLinkField HeaderText="±à¼­" ControlStyle-Width="50" DataNavigateUrlFields="NicheID" DataNavigateUrlFormatString="Modify.aspx?id={0}"
                                Text="±à¼­"  />
