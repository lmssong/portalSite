...
<!--Title -->
		...
		<asp:BoundField DataField="Lianxi" HeaderText="Lianxi" SortExpression="Lianxi" ItemStyle-HorizontalAlign="Center"  /> 
                            ...
                            <asp:HyperLinkField HeaderText="ÏêÏ¸" ControlStyle-Width="50" DataNavigateUrlFields="JobID" DataNavigateUrlFormatString="Show.aspx?id={0}"
                                Text="ÏêÏ¸"  />
                            <asp:HyperLinkField HeaderText="±à¼­" ControlStyle-Width="50" DataNavigateUrlFields="JobID" DataNavigateUrlFormatString="Modify.aspx?id={0}"
                                Text="±à¼­"  />
