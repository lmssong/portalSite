...
<!--Title -->
		...
		<asp:BoundField DataField="Procontent" HeaderText="Procontent" SortExpression="Procontent" ItemStyle-HorizontalAlign="Center"  /> 
                            ...
                            <asp:HyperLinkField HeaderText="ÏêÏ¸" ControlStyle-Width="50" DataNavigateUrlFields="ProID" DataNavigateUrlFormatString="Show.aspx?id={0}"
                                Text="ÏêÏ¸"  />
                            <asp:HyperLinkField HeaderText="±à¼­" ControlStyle-Width="50" DataNavigateUrlFields="ProID" DataNavigateUrlFormatString="Modify.aspx?id={0}"
                                Text="±à¼­"  />
