<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="jishuInfo.aspx.cs" Inherits="Maticsoft.Web.Admin.jishuInfo" %>
	  ...
	  <div class="adminleft">
	   ...
	   <!--右边内容 -->
	    ...
	    <div class="adminNewslist">
		  <div class="adminNewslist1">技术资料信息 </div>
		...
		<div class="adminNewslist3">
		  ...
		  <div class="adminNewslist5">
              <asp:Label ID="lblwenjian" runat="server"></asp:Label></div>
		</div>
		<div class="adminNewslist3">
		...
		<div class="adminNewslist6">
		  ...
		  <div class="adminNewslist62">
              <asp:Image ID="Image1" runat="server" style=" margin-left:15px;" Height="200px" />
		  </div>
		</div>
		...
		<div class="adminNewslist6">
		  ...
		  文件描述：</div>
		  <div class="adminNewslist62">
              &nbsp;<asp:TextBox ID="txtNewContent" runat="server" BackColor="White" Height="230px"
                  TextMode="MultiLine" Width="409px"></asp:TextBox></div>
		</div>
