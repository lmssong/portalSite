<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tujianList.aspx.cs" Inherits="Maticsoft.Web.Admin.tujianList" %>
	  ...
	  <div class="adminright">
	   <!--右边内容 -->
	    ...
	    <div class="adminNewslist">
		  <div class="adminNewslist1">推荐产品列表 </div>
		...
		<div class="adminNewslist4">
		  ...
		  <div class="adminNewslist42">产品类型</div>
