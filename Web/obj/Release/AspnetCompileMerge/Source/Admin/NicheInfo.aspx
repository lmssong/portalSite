<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NicheInfo.aspx.cs" Inherits="Maticsoft.Web.Admin.hangyeInfo" %>
	  ...
	  <div class="adminleft">
	   ...
	   <!--右边内容 -->
	    ...
	    <div class="adminNewslist">
		  <div class="adminNewslist1">添加行业信息 </div>
		...
		<div class="adminNewslist3">
		  ...
		  <div class="adminNewslist5">
              <asp:Label ID="lbldatime" runat="server"></asp:Label></div>
		</div>
		...
		<div class="adminNewslist6">
		  <div class="adminNewslist61"><br/>行业内容：</div>
		  <div class="adminNewslist62">
              <asp:TextBox ID="txtcontent" runat="server" Height="240px" TextMode="MultiLine" Width="300px"></asp:TextBox></div>
		</div>
