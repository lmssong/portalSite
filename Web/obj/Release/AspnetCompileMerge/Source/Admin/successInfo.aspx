<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="successInfo.aspx.cs" Inherits="Maticsoft.Web.Admin.successInfo" %>
	  ...
	  <div class="adminright">
	   <!--右边内容 -->
	    ...
	    <div class="adminNewslist">
		  <div class="adminNewslist1">成功案例信息 </div>
		...
		<div class="adminNewslist6">
		  ...
		  <div class="adminNewslist62">
              <asp:Image ID="Image1" runat="server" Height="240px" /></div> 
		</div>
		<div class="adminNewslist6">
		  <div class="adminNewslist61"><br/>
		  案例描述：</div>
