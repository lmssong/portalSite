<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddNiche.aspx.cs" Inherits="Maticsoft.Web.Admin.AddNiche" %>
	  ...
	  <div class="adminright">
	   <!--右边内容 -->
		...
		<div class="adminNewslist3 STYLE1"> 
		 ...
		 <div class="adminNewslist3 STYLE1">添加行业类型：<asp:TextBox ID="txtaddtype" runat="server"></asp:TextBox>
