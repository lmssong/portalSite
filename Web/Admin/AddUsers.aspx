<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddUsers.aspx.cs" Inherits="Maticsoft.Web.Admin.AddUsers" %>
	  ...
	  <div class="adminright">
	   <!--右边内容 -->
	    ...
	    <div class="adminNewslist">
		  <div class="adminNewslist1">添加用户</div>
		...
		<div class="adminNewslist3">
		  <div class="adminNewslist10">用户账号：</div>
		  <div class="adminNewslist5">
              &nbsp;<asp:TextBox ID="txtname" runat="server" BackColor="White"></asp:TextBox><span
                  style="color: #ff3333">* (请确保唯一性)<asp:Label ID="lblusername" runat="server"></asp:Label></span></div>
		</div>
		<div class="adminNewslist3">
		  <div class="adminNewslist10">用户密码：</div>
		  <div class="adminNewslist5">
		...
		<div class="adminNewslist3">
		  <div class="adminNewslist10">确认密码：</div>
		  <div class="adminNewslist5">
