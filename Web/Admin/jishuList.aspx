<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="jishuList.aspx.cs" Inherits="Maticsoft.Web.Admin.jishuList" %>
	  ...
	  <div class="adminleft">
	   ...
	   <!--右边内容 -->
	    ...
	    <div class="adminNewslist">
		  <div class="adminNewslist1">技术资料列表 </div>
		  <div class="adminNewslist2"></div>
	    </div>
		<div class="adminNewslist3"></div>
		
		<div class="adminNewslist4">
		  <div class="adminNewslist41">技术标题</div>
		  <div class="adminNewslist42">发布时间</div>
		  <div class="adminNewslist42">文件类别</div>
		  <div class="adminNewslist42">编辑</div>
		</div>
		
		<asp:DataList ID="datajishu" runat="server" OnDeleteCommand="datajishu_DeleteCommand" >
          <ItemTemplate >
              <div class="adminNewslist43">
		  <div class="adminNewslist431">
		    <a href ="jishuInfo.aspx?JishuID=<%#Eval("JishuID") %>">
		      <%#Eval("JishuTitle") %>
		    </a>
		  </div>
		  ...
		  <div class="adminNewslist432"> 
		   <a href ="jishuModify.aspx?JishuID=<%#Eval("JishuID") %>" style="color:#0099FF"> 修改</a> 
