<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="fuwuList.aspx.cs" Inherits="Maticsoft.Web.Admin.fuwuList" %>
	  ...
	  <div class="adminright">
	   <!--右边内容 -->
	    ...
	    <div class="adminNewslist">
		  <div class="adminNewslist1">服务列表 </div>
		  <div class="adminNewslist2"></div>
	    </div>
		<div class="adminNewslist3"></div>
		
		<div class="adminNewslist4">
		  <div class="adminNewslist41">服务标题</div>
		  <div class="adminNewslist42">发布时间</div>
		  <div class="adminNewslist42">服务类型</div>
		  <div class="adminNewslist42">编辑</div>
		</div>
		
		<asp:DataList ID="datafuwu" runat="server" OnDeleteCommand="datading_DeleteCommand" OnItemDataBound="datading_ItemDataBound">
          <ItemTemplate >
		  ...
		  <div class="adminNewslist432"> 
		    <asp:Label ID="lnltype" runat="server" Text=<%#Eval("FuwuTypeID") %>></asp:Label>
		  </div>
		  <div class="adminNewslist432">
		  
		   <a href ="fuwuInfo.aspx?fuwuID=<%#Eval("fuwuID") %>" style="color:#0099FF"> 修改</a> 
