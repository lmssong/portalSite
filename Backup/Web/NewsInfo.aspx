<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewsInfo.aspx.cs" Inherits="Maticsoft.Web.NewsInfo1" %>
...
<head runat="server">
    <title>深圳市宏润众达科技有限公司-企业新闻</title>
		  ...
		  <div class="divjies">
		    <div class="divjies1">
			  <img src="images/xuan.png" width="15" height="15" />
                <asp:Label ID="lblNewsTypeTitle" runat="server"></asp:Label>
			</div>
			<div class="divjies2">
			  ...
			  <div class="divNewinfo2">
				...
				<div class="divNewinfo21">
				  新闻类型：
				  <asp:Label ID="lblNewsTypeTitle1" runat="server"></asp:Label>
				</div>
				<div class="divNewinfo21">
				  发布人：
			  ...
			  <div class="divNewinfo1">
			    <div style="float:left; ">
                  <asp:Image ID="imgnews" runat="server"  Height="250" /></div>
