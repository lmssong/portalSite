	  ...
	  <div class="adminright">
	   <!--右边内容 -->
	    ...
	    <div class="adminNewslist">
		  <div class="adminNewslist1">添加新闻 </div>
		  <div class="adminNewslist2">
		   <a href ="newslist.aspx" >已发布新闻</a>
		  </div>
	    </div>
		<div class="adminNewslist3 STYLE1"> 带有“<span class="STYLE2">*</span>”为必填项</div>
		<div class="adminNewslist3 STYLE1"> </div>
		<div class="adminNewslist3 STYLE1"> 
		   添加新闻类型：<asp:TextBox ID="txtaddtype" runat="server"></asp:TextBox> 
            <asp:Button ID="btnaddtype" runat="server" Text="添加类型" OnClick="btntype_Click" />
		...
		<div class="adminNewslist3">
		  ...
		  <div class="adminNewslist5">
              &nbsp;<asp:TextBox ID="txtNewsTitle" runat="server" BackColor="White"></asp:TextBox><span style="color: #ff3333">*<asp:Label
                  ID="lblNewsTitle" runat="server"></asp:Label>
              </span>
		  </div>
		</div>
		<div class="adminNewslist3">
		...
		<div class="adminNewslist3">
		  ...
		  <div class="adminNewslist5">
              &nbsp;<asp:DropDownList ID="drpNewsType" runat="server" Width="152px" BackColor="White">
              </asp:DropDownList></div>
		</div>
		<div class="adminNewslist3">
		  <div class="adminNewslist10">发布人：</div>
		  <div class="adminNewslist5">
              &nbsp;<asp:TextBox ID="txtwrite" runat="server" BackColor="White"></asp:TextBox><span
                  style="color: #ff3333">*<asp:Label ID="lblwrite" runat="server"></asp:Label>
              </span>
		  </div>
		</div>
		...
		<div class="adminNewslist3">
		  ...
		  <div class="adminNewslist5">
              &nbsp;<asp:TextBox ID="txtfatime" runat="server" onfocus="calendar()" BackColor="White"></asp:TextBox>
              <span style="color: #ff3333">*<asp:Label ID="lblfatime" runat="server"></asp:Label>
              </span>
		  </div>
		</div>
		<div class="adminNewslist3">
		  <div class="adminNewslist10"> 新闻图片：</div>
		  <div class="adminNewslist5">
		...
		<div class="adminNewslist6">
		  ...
		  <div class="adminNewslist62">
              &nbsp;<asp:TextBox ID="txtNewContent" runat="server" Height="230px" TextMode="MultiLine" Width="409px" BackColor="White"></asp:TextBox>
          </div>
		</div>
