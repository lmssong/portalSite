<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Adddinggou.aspx.cs" Inherits="Maticsoft.Web.Admin.Adddinggou" %>
	  ...
	  <div class="adminright">
	   <!--右边内容 -->
	    ...
	    <div class="adminNewslist">
		  <div class="adminNewslist1">添加订购</div>
		  <div class="adminNewslist2">
		   <a href ="dinggouList.aspx">订购列表</a>
		  </div>
	    </div>
		...
		<div class="adminNewslist3">
		  <div class="adminNewslist10">订购日期：</div>
		  <div class="adminNewslist5">
		    <asp:TextBox ID="txtDingtime" runat="server" onfocus="calendar()" BackColor="White" BorderColor="White" Width="200px"></asp:TextBox>
              <span style="color: #ff3333">*<asp:Label ID="lblDatatime" runat="server"></asp:Label></span></div>
		</div>
