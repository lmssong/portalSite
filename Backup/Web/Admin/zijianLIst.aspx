<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="zijianLIst.aspx.cs" Inherits="Maticsoft.Web.Admin.zijianLIst" %>
	  ...
	  <div class="adminright">
	   <!--右边内容 -->
	    ...
	    <div class="adminNewslist">
		  <div class="adminNewslist1">自我推荐 </div>
		  <div class="adminNewslist2"></div>
	    </div>
		<div class="adminNewslist3"></div>
		
		<div class="adminNewslist4">
		  <div class="adminNewslist41">自荐职位</div>
		  <div class="adminNewslist42">自荐时间</div>
		  <div class="adminNewslist42">专业要求</div>
		  <div class="adminNewslist42">编辑</div>
		</div>
		<asp:DataList ID="datazijian" runat="server" OnDeleteCommand="datazijian_DeleteCommand" >
          <ItemTemplate >
            <div class="adminNewslist43">
		  <div class="adminNewslist431">
		    <a href ="zijianInfo.aspx?JobInfoID=<%#Eval("JobInfoID") %>">
		      <%#Eval("Jobtitle")%>
		    </a>
		  </div>
		  <div class="adminNewslist432">
		     <%#((DateTime)Eval("datatime")).ToString("yyyy-MM-dd")%>
		  </div>
		  <div class="adminNewslist432">
		   
            <asp:Label ID="lbltype" runat="server" Text=<%#Eval("Zhuanye")%>></asp:Label>
		  </div>
		  <div class="adminNewslist432">
