<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewsLIst.aspx.cs" Inherits="Maticsoft.Web.Admin.NewsLIst" %>
	  ...
	  <div class="adminright">
	   <!--右边内容 -->
		...
		<div class="adminNewslist4">
		  <div class="adminNewslist41">新闻标题</div>
		  <div class="adminNewslist42">发布时间</div>
		  <div class="adminNewslist42">新闻类型</div>
		...
		<asp:DataList ID="datamess" runat="server" OnDeleteCommand="datamess_DeleteCommand1" OnItemDataBound="datamess_ItemDataBound"    >
		  ...
		  <div class="adminNewslist432">
		   <a href ="NewsModify.aspx?NewsID=<%#Eval("NewsID") %>"  style="color :#0099FF"> 修改
		   </a>
