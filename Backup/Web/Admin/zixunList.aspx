<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="zixunList.aspx.cs" Inherits="Maticsoft.Web.Admin.zixunList" %>
	  ...
	  <div class="adminright">
	   <!--右边内容 -->
	    ...
	    <div class="adminNewslist">
		  <div class="adminNewslist1">项目咨询列表</div>
		  <div class="adminNewslist2"></div>
	    </div>
		<div class="adminNewslist3"></div>
		
		<div class="adminNewslist4">
		  <div class="adminNewslist41">咨询标题</div>
		  <div class="adminNewslist42">咨询时间</div>
		  <div class="adminNewslist42">发布人</div>
		  <div class="adminNewslist42">编辑</div>
		</div>
		<asp:DataList ID="datazixun" runat="server" OnDeleteCommand="datazixun_DeleteCommand"  >
          <ItemTemplate >
            <div class="adminNewslist43">
		  <div class="adminNewslist431">
		    <a href ="zixunInfo.aspx?zixunID=<%#Eval("zixunID") %>">
		      <%#Eval("zixunTitle")%>
		    </a>
		  </div>
		  ...
		  <div class="adminNewslist432">
		    <a href ="zixunModify.aspx?zixunID=<%#Eval("zixunID") %>"  style="color :#0099FF"> 修改
		   </a>
