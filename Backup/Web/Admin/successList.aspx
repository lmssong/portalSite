<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="successList.aspx.cs" Inherits="Maticsoft.Web.Admin.successList" %>
	  ...
	  <div class="adminright">
	   <!--右边内容 -->
		...
		<asp:DataList ID="datasuccess" runat="server" OnDeleteCommand="datasuccess_DeleteCommand"  >
		  ...
		  <div class="adminNewslist432">
		   <a href ="successModify.aspx?SuccessID=<%#Eval("SuccessID") %>"  style="color :#0099FF"> 修改
		   </a>
