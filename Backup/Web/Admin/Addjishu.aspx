<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Addjishu.aspx.cs" Inherits="Maticsoft.Web.Admin.Addjishu" %>
	  ...
	  <div class="adminright">
	   <!--右边内容 -->
	    ...
	    <div class="adminNewslist">
		  <div class="adminNewslist1">添加技术资料 </div>
		  <div class="adminNewslist2">
		    <a href ="jishuList.aspx" >技术列表</a>
		  </div>
	    </div>
